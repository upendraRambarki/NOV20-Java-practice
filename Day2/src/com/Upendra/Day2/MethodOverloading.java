...
public class MethodOverloading {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getEnergyEfficiency('b',2));
        getEnergyEfficiency('a',3);
        getEnergyEfficiency('c',1);
    ...
    static String getEnergyEfficiency(char category,int num){
        switch (category){
            case 'A':
            case 'a':
            	for(int i=1;i<=num;i++) {
            		System.out.println("hi upendra printing a");
            		//break;
            	}
            ...
            case 'C':
            case 'c':
                System.out.println("upendra printing c"); 
            case 'D':
            case 'd':
